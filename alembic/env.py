...
# from app.models.user import User  # DEPRECADO
from app.models.user_extended import (
    TipoRolUsuario, TipoNivelUsuario, TipoMetodoPago,
    Usuario, UsuarioRol, UsuarioNivel, UsuarioMetodoPago, Referido
)
from app.models.beer import TipoEstiloCerveza, Cerveza, CervezaEstilo, PrecioCerveza
...
from app.models.rewards import CatalogoPremio, Canje
from app.models.transactions import TransaccionPuntos, Pago
